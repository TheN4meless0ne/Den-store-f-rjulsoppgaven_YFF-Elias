...
def load_data(language):
    ...
    with open(os.path.join(app.root_path, f'{data_path}/dataportfolio.json'), encoding='utf-8') as f:
        portfolio_data = json.load(f)
    with open(os.path.join(app.root_path, f'{data_path}/dataindex.json'), encoding='utf-8') as f:
        index_data = json.load(f)
    with open(os.path.join(app.root_path, f'{data_path}/image.json'), encoding='utf-8') as f:
        image_data = json.load(f)
    with open(os.path.join(app.root_path, f'{data_path}/pdf.json'), encoding='utf-8') as f:
        pdf_data = json.load(f)
    with open(os.path.join(app.root_path, f'../infomodule/translations/translations{language}.json'), encoding='utf-8') as f:
